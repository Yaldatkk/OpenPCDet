...
class CustomDataset(DatasetTemplate):
    ...
    def generate_prediction_dicts(batch_dict, pred_dicts, class_names, output_path=None):
        ...
        def get_template_prediction(num_samples):
            ret_dict = {
            'name': [''] * num_samples,  # Assuming 'name' should be a list of empty strings
...
def create_custom_infos(dataset_cfg, class_names, data_path, save_path, workers=4):
    ...
    # Filenames for different splits
    train_filename = save_path / ('custom_infos_%s.pkl' % train_split)
    val_filename = save_path / ('custom_infos_%s.pkl' % val_split)  # Fixed typo here
    trainval_filename = save_path / 'custom_infos_trainval.pkl'
    test_filename = save_path / f'custom_infos_{test_split}.pkl'
    ...
    dataset.set_split(train_split)
    # Input the 'custom_infos_train.pkl' to generate gt_database
